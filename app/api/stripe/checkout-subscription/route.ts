...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const monthlyPriceId = process.env.STRIPE_PRO_MONTHLY_PRICE_ID || process.env.NEXT_PUBLIC_STRIPE_PRO_PRICE_ID
    ...
    if (!priceId) {
      console.error('Missing Stripe price ID. Set STRIPE_PRO_MONTHLY_PRICE_ID or NEXT_PUBLIC_STRIPE_PRO_PRICE_ID')
