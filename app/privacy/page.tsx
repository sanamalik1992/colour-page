    ...
    <div className="min-h-screen app-bg">
      ...
      <main className="container mx-auto px-6 py-16 max-w-3xl text-gray-300">
        ...
        <p className="mb-4">
          ...
          <strong className="text-white">ZC207608</strong>.
        </p>
        <p className="mb-4">
        ...
        <Section title="9. Contact us">
          ...
          <p className="text-sm text-gray-400">Registered with the UK Information Commissioner&rsquo;s Office (ICO), registration number ZC207608.</p>
        </Section>
