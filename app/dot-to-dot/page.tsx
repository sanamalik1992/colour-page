        ...
        <div className="max-w-3xl mx-auto text-center">
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input 
                    ...
                    className="flex-1 h-14 px-5 bg-zinc-900 border border-zinc-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20" 
                  />
                  <button 
                    onClick={handleNotify}
                    className="h-14 px-8 bg-gradient-to-r from-amber-400 to-orange-500 text-white font-bold rounded-xl hover:from-amber-500 hover:to-orange-600 transition-all shadow-lg shadow-amber-500/20"
                  >
                    Notify Me
                  </button>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-12">
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">Numbered Dots</h3>
              <p className="text-sm text-gray-400">Clear numbers from 1-100+ for easy connecting</p>
            </div>
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-2xl p-6">
              <div className="text-3xl mb-3">🎯</div>
              <h3 className="font-bold text-white mb-2">Smart Detection</h3>
              <p className="text-sm text-gray-400">AI finds the perfect outline automatically</p>
            </div>
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-2xl p-6">
              <div className="text-3xl mb-3">🖨️</div>
              <h3 className="font-bold text-white mb-2">Print Ready</h3>
              <p className="text-sm text-gray-400">A4 format, perfect for home printing</p>
            </div>
          </div>

          {/* CTA */}
          <div className="pt-8 border-t border-zinc-800">
            <p className="text-gray-400 mb-4">In the meantime, try our coloring page generator:</p>
